                    ...
                    @else
                        <div id="{{ $work->id }}" class="relative w-full" data-carousel="static">
                            ...
                            <button type="button"
                                    ...
                                    data-carousel-prev>
        <span
            class="inline-flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-blue/30 dark:bg-gray-800/30 group-hover:bg-blue/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-blue dark:group-focus:ring-gray-800/70 group-focus:outline-none">
            <svg aria-hidden="true" class="w-5 h-5 text-blue sm:w-6 sm:h-6 dark:text-gray-800" fill="none"
            ...
            <span class="sr-only">Previous</span>
                            ...
                            <button type="button"
                                    ...
                                    data-carousel-next>
        <span
            class="inline-flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-blue/30 dark:bg-blue-800/30 group-hover:bg-blue/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-blue dark:group-focus:ring-blue-800/70 group-focus:outline-none">
            <svg aria-hidden="true" class="w-5 h-5 text-blue sm:w-6 sm:h-6 dark:text-gray-800" fill="none"
                 stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path
